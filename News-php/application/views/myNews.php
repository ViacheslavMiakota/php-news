...
$articles = isset($_SESSION['articles']) ? $_SESSION['articles'] : array(); // Get session data
...
<body>
    ...
    <div class="container mt-5 mb-5">
        <div class="out-box">
            ...
            <h2 class="myNews-title"><?= $_SESSION['user']['name'] ?></h2>
            <a href=""><?= $_SESSION['user']['login'] ?></a>
            <h4 class="myNews-title"><?= $_SESSION['user']['role'] ?></h4>
        </div>
        <div class="item-news">
